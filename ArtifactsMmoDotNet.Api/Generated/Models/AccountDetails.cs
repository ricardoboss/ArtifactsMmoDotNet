...
#nullable enable
        public global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails.AccountDetails_badges? Badges
        {
            get { return BackingStore?.Get<global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails.AccountDetails_badges?>("badges"); }
...
#nullable restore
        ...
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails_badgesMember1"/>, <see cref="Null"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.18.0")]
        public partial class AccountDetails_badges : IBackedModel, IComposedTypeWrapper, IParsable
        {
            /// <summary>Composed type representation for type <see cref="global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails_badgesMember1"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails_badgesMember1? AccountDetailsBadgesMember1
            {
                get { return BackingStore?.Get<global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails_badgesMember1?>("AccountDetails_badgesMember1"); }
                set { BackingStore?.Set("AccountDetails_badgesMember1", value); }
            }
#nullable restore
#else
            public global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails_badgesMember1 AccountDetailsBadgesMember1
...
#nullable restore
...
#endif
            /// <summary>
            /// Instantiates a new <see cref="global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails.AccountDetails_badges"/> and sets the default values.
            /// </summary>
            public AccountDetails_badges()
            {
                BackingStore = BackingStoreFactorySingleton.Instance.CreateBackingStore();
            }
            /// <summary>
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails.AccountDetails_badges"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails.AccountDetails_badges CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var result = new global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails.AccountDetails_badges();
                if(parseNode.GetObjectValue<Null>(Null.CreateFromDiscriminatorValue) is Null nullValue)
                {
                    result.Null = nullValue;
                }
                else {
                    result.AccountDetailsBadgesMember1 = new global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails_badgesMember1();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(AccountDetailsBadgesMember1 != null)
                {
                    return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(AccountDetailsBadgesMember1);
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(Null != null)
                {
                    ...
                    writer.WriteObjectValue<global::ArtifactsMmoDotNet.Api.Generated.Models.AccountDetails_badgesMember1>(null, AccountDetailsBadgesMember1);
                }
            }
        }
    }
